...
def litCricFriend(wordList, text):
    ...
    # One line of code.
    replaceCharactersInText = lowerCaseText.replace('--', ' ')
    ...
    for word in splitText:
       stripWords.append(word.strip(string.punctuation))
    ...
    for word in wordList:
        newWord = word.lower()
        if newWord in stripWords:
            sum += stripWords.count(newWord)
...
'''
the frequency of the times the author of 'the bells' uses a and an is higher than the auther of 'cantoXII' and the frequency of the times the auther of 'the bells' is higher than the author of 'cantoXII' 
'''
